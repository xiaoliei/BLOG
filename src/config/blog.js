		...
		posts: [
			{
				...
				readTime: 4,
				excerpt:
					"把旧书架拆了重搭，顺便给小镇西街修了一条排水渠。生活就是在 1×1 的方块里不断微调。",
			},
			{
				title: "雨季来了，记得给屋顶换瓦",
				date: "2026-07-12",
				...
				readTime: 3,
				excerpt:
					"连续三天下雨，镇北三栋房的瓦片渗水。总结了一份换瓦流程和防潮小贴士。",
			},
			{
				title: "邻居家的猫又偷了我的鱼",
				date: "2026-06-30",
				...
				readTime: 2,
				excerpt:
					"今天在码头抓到一只灰色短毛猫，身上有红项圈。失主请来钟楼认领，附赠鲑鱼一条。",
			},
		],
	},
	{
		...
		posts: [
			{
				...
				readTime: 8,
				excerpt:
					"重新读了一遍原研哉，重点记下“白”与“留白”的关系，以及他关于信息建筑的三层理解。",
			},
			{
				...
				readTime: 10,
				excerpt:
					"一百个透镜太多，真正常用的是好奇、惊喜与悬念那几面。整理了一份自己的透镜清单。",
			},
			{
				title: "《禅与摩托车维修艺术》随想",
				date: "2026-05-09",
				...
				readTime: 6,
				excerpt:
					"良质到底是什么？骑车修车和写代码一样，都是让自己进入“当下”的练习。",
			},
		],
	},
	{
		...
		posts: [
			{
				title: "小礼工坊 v2：把博客做成了体素世界",
				date: "2026-07-25",
				tags: ["项目", "React"],
				readTime: 12,
				excerpt:
					"从启动页到方块大陆，一次把个人站改造成游戏地图的完整记录：架构、配色与踩坑。",
			},
			{
				...
				readTime: 9,
				excerpt:
					"基于值噪声的 fBm 地形：海洋、山脉、沙漠与河流的生成思路，附关键代码片段。",
			},
			{
		...
		posts: [
			{
				...
				readTime: 11,
				excerpt:
					"三天两夜，从西河源头出发，穿过两片橡木林，最后在珊瑚灯塔看了场日落。",
			},
			{
				title: "沙漠边缘的旧日遗迹",
				date: "2026-06-08",
				...
				readTime: 9,
				excerpt:
					"风化的石柱上刻着看不懂的符号。拍了 47 张照片，回来拼了一个 3D 草模。",
			},
			{
				title: "矿洞里的萤石矿脉",
				date: "2026-04-19",
				...
				readTime: 6,
				excerpt:
					"深红矿洞第七层发现了一整条萤石脉，比火把亮多了。附一组矿灯光照对比。",
			},
		],
	},
	{
		...
		posts: [
			{
				...
				readTime: 15,
				excerpt:
					"把 Fiber 协调、优先级与并发特性讲成一条矿脉图，挖到哪一层心里就更有数。",
			},
			{
				...
				readTime: 10,
				excerpt:
					"6144 个瓷砖如何做到 16ms 内画完：离屏缓存、脏矩形与避免 shadowBlur 的教训。",
			},
			{
			...
			},
			{
				...
				readTime: 8,
				excerpt:
					"纹理没释放、上下文没清理，一次真实的 Three.js 泄漏从 300MB 降到 80MB。",
			},
		],
	},
	{
		...
		posts: [
			...
			},
			{
				...
				readTime: 6,
				excerpt:
					"半年复盘：三个项目、一次重构、若干次半途而废，以及下学期的路线图。",
			},
			{
				title: "联系我 / 合作通道",
				date: "2026-01-01",
		...
		posts: [
			{
				...
				readTime: 7,
				excerpt:
					"一个用方向键控制的 shell 迷宫，输入命令解谜。原型 300 行，很好玩。",
			},
			{
				title: "CSS 像素风力发电站",
				date: "2026-06-02",
				...
				readTime: 4,
				excerpt:
					"纯 CSS 转动的风车叶片，用了 steps() 和 transform-origin 的小技巧。",
			},
			{
	...
	},
	{
		...
		posts: [
			...
			},
			{
				...
				readTime: 9,
				excerpt:
					"第一版是纯静态 HTML + 本地 vendor，最后迁移到 Vite + React 的过程与取舍。",
			},
			{
				title: "2019 年的第一篇博客",
				date: "2019-03-17",
				...
				readTime: 2,
				excerpt:
					"当年还在用 CSS 画圣诞树，文章很幼稚，但那是所有故事的第一块砖。",
			},
		],
	},
];
...
export const ALL_POSTS = MODULES.flatMap((module) =>
	module.posts.map((post) => ({
		...
		moduleAccentDark: module.accentDark,
	})),
