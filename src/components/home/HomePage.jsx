...
export default function HomePage() {
  ...
  const handleOpen = useCallback((post, module) => setSelected({ post, module }), []);
    ...
    <div className="blog-root">
      ...
      <header id="top" className="hero">
        <nav className="hero-nav container" aria-label="主导航">
          <a className="hero-logo" href="#top">
            <span className="hero-logo__mark">B</span>
            BLOG_OS
          </a>
          ...
          <div className="section-head">
            <div>
              ...
              <p className="section-sub">
                {activeModule ? activeModule.blurb : `按时间倒序，先看最近更新的 ${LATEST_LIMIT} 篇。`}
              </p>
            </div>
            {activeModule && (
              <button type="button" className="btn btn--ghost" onClick={() => setActiveModuleId(null)}>
                清除筛选
              </button>
            )}
          </div>
        ...
        <section id="modules" className="section" aria-labelledby="modules-title">
          <div className="section-head">
            <div>
              ...
              <p className="section-sub">八个栏目，八块拼图。点击任意栏目查看其中的文章。</p>
            </div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <span className="module-card__body">
                    ...
                    <span className="module-card__count">{module.posts.length} 篇文章</span>
                  </span>
                </button>
              );
            })}
          ...
          <div className="about-card reveal">
            ...
            <div className="about-body">
              ...
              <p className="about-text">
                这里是 BLOG_OS 的建造者 {SITE.author}。从 2019 年写下第一篇文章开始，
      ...
      <footer className="site-footer">
        ...
        <div className="container footer-bottom">
          ...
          <span>背景样式参考 xiaoli.team</span>
        </div>
      </footer>

      {selected && <ArticleModal post={selected.post} module={selected.module} onClose={handleClose} />}
    </div>
  );
}
